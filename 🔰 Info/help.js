  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        .addField("<a:owner:937596959521407027> **__My Features__**",
`>>> **58+ Systems**, like: <:twitter:937596935341240320> **Twitter-** & <a:ytube:937596935634817024> **Youtube-Auto-Poster** 
**Application-**, Ticket-, **Welcome-Images-** and Reaction Role-, ... Systems
<a:music:937596958191808512> An advanced <:spotify:937596935634829332> **Music System** with **Audio Filtering**
<a:mc:937596938038177792> Many **Minigames** and <a:rocking:937596934938591252> **Fun** Commands (150+)
<a:moderation:937596933885816852> **Administration** and **Auto-Moderation** and way much more!`)
...
.addField("<a:setting2:937596943297810443> **__STATS:__**",
`>>> <a:search:937596946674225153> **${client.commands.map(a=>a).length} Commands**
<:Commands:937596931973189652> on **${client.guilds.cache.size} Guilds**
<a:uptime:937596957856243722> **${duration(client.uptime).map(i=> `\`${i}\``).join("︲")} Uptime**
<a:ping:937596928521297950> **\`${Math.floor(client.ws.ping)}ms\` Ping**
<:announcement:937596929192378408>  Made by [**Milrato Development**](https://discord.gg/milrato)`)
.addField("<a:infor22:937596933168578590> How to get help?", `>>> **\` 1. Way \`** *Use the Buttons, to swap the Pages*\n**\` 2. Way \`** *Use the Menu to select all Help Pages, you want to display*\n**\` 3. Way \`** *Watch the Youtube Tutorial*`)
